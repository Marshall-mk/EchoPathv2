...
class AgentSiameseNetwork:
    def __init__(self, config):
        ...
        self.SAVINGS_PATH = '/nfs/usrhome/khmuhammad/EchoPath/experiments/' + self.config['experiment_description'] + '/'
...
if __name__ == '__main__':
    ...
    os.makedirs(os.path.join('/nfs/usrhome/khmuhammad/EchoPath/experiments/' , config['experiment_description']), exist_ok=True)
    SAVINGS_PATH = '/nfs/usrhome/khmuhammad/EchoPath/experiments/' + config['experiment_description'] + '/'
