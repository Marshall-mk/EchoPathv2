...
from echo.common.datasets import ImageSet, TensorSet, TensorSetv5
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        while not finished:
            # for cond, value in dataloader: # for csv only
            for cond in dataloader: # for other
                if finished:
                    break
