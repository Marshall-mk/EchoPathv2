...
def main():
    pred_seq_path = "/nfs/usrhome/khmuhammad/EchoPath/datasets/EchoNet-Dynamic/experiments/kfd_dyn/dyn.csv"
    ED_start_dict = {}
    ED_end_dict = {}
    ES_dict = {}
    ...
    df.to_csv("/nfs/usrhome/khmuhammad/EchoPath/datasets/EchoNet-Dynamic/experiments/kfd_dyn/dyn_results.csv", index=False)
